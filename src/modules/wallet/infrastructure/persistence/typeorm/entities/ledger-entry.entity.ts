...
import { BalanceChangeRequestEntity } from '../../../../../balance-change-request/infrastructure/persistence/typeorm/entities/balance-change-requests.entity';
...
export class LedgerEntryEntity extends BaseOrmEntity {
  ...
  @Column({ name: LEDGER_ENTRY_SCHEMA.COLUMNS.BALANCE_AFTER, type: 'numeric' })
  balanceAfter: number;
